	...
	# LEFT VERSION
		...
		print("LLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLLL")
                if (ob.mode == Position.LEFT):
                    obstacle_cnt += 1
	    	    if obstacle_cnt == 1:   
                        for theta in range(270, 515, 10): #10  # (270, 515, 16)
			...
			st = 0
		        for theta in range(280, 570, 13):   # (270, 515, 16)
                            st = 0.30 * np.sin(theta * np.pi / 180) #0.68
                            drive(st, car_run_speed)
                            time.sleep(0.1) 
			for i in range(3000):
			    drive(st, car_run_speed)
                    ...
                    obstacle_cnt += 1
                    if obstacle_cnt == 2:
                        for theta in range(270, 530, 12): # (280, 440, 10) #270,450, 8
                            st = 0.6 * np.sin(theta * np.pi / 180) #0.9
                            drive(-st, car_run_speed)
                            time.sleep(0.1)
		    ...
		    obstacle_cnt += 1
	  	    ...
	  	    if obstacle_cnt == 3:
 		        for theta in range(270, 510, 9): #270,450, 8
                            st = 0.35 * np.sin(theta * np.pi / 180) #0.9
                            drive(-st, car_run_speed)
                            time.sleep(0.1)
                    continue
